...
/* 설명. Service 계층 이후부터는 xml방식, javaconfig 방식, remix 방식 중 어떤 것을 선택할 지 고민해서 진행해야 한다.
    remix 방식의 경우는,
    ...
    3. mxl 파일명과 mapper용 인터페이스명이 동일해야 한다.
 */
...
public class MenuService {
    public List<MenuDTO> findAllMenu() {
        ...
        /* 설명. remix 방식에선 Service 계층에 MenuMapper 인터페이스를 구현하여 xml과 연동 */
...
//        System.out.println("MenuService 계층의 registMenu 메소드 실행...");
