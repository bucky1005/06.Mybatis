...
public class Application {
    public static void main(String[] args) {
        ...
        do {
            /* 설명. 동적 SQL (게시판 검색 기능에 주로 사용됨)
                사용자가 넘기는 값에 따라 매번 자동으로 SQL문이 달라짐을 의미함. */
    ...
    /* 설명. 프로그램 1번 메뉴 */
    /* 메모. 메소드 하나 당 html 페이지 하나라고 생각하면 됨 */
        ...
        do {
            ...
            switch (num) {
                case 1:
                    ...
                    break;
                case 2:
                    menuService.searchMenu(inputSerachCriteria());
                    break;
                case 9: return;
            }
        } while (true);
    ...
    public static int inputPrice() {
        Scanner sc = new Scanner(System.in);
        System.out.println("검색할 가격대의 최대 금액을 입력해 주세요");

        return sc.nextInt();
    }

    public static SearchCriteria inputSerachCriteria() {
        Scanner sc = new Scanner(System.in);
    ...
    public static void foreachSubMenu() {
        ...
        do {
            ...
            switch (num) {
                case 1:
                    menuService.searchMenuByRandomMenuCode(generalRandomMenuCodeList());
                    break;
                case 9: return;
            }
        } while (true);
    ...
    private static List<Integer> generalRandomMenuCodeList() {
//        System.out.println("generalRandomMenuCodeList 실행");
